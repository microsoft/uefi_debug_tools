...
public:
  ...
  hr_exception(
               ...
               ) : std::exception (msg.c_str ()), m_hr (hr)
  {
  }

  hr_exception(
               _In_ HRESULT       hr,
               _In_z_ const char  *pMsg
               ) : std::exception (pMsg), m_hr (hr)
  {
  }
...
public:
  ...
  object_detached(
                  ) : runtime_error ("Attempt to access a detached object")
  {
  }
};
...
struct Exceptions {
  ...
  ThrowHr (
    _In_ HRESULT           hr,
    _In_opt_ IModelObject  *pError = nullptr
    )
  {
    std::string  msg;
  ...
  static HRESULT
  ReturnResult (
    _In_ const std::exception_ptr    &exception,
    _COM_Errorptr_opt_ IModelObject  **ppError = nullptr
    )
  {
    HRESULT       hr = E_FAIL;
    std::wstring  errMsg;
...
CheckHr (
  _In_ HRESULT                     hr,
  _In_ const ComPtr<IModelObject>  &potentialError
  )
{
  if (FAILED (hr)) {
...
template<typename TDestSymbol> TDestSymbol
symbol_cast (
  _In_ const ComPtr<IDebugHostSymbol>  &spSymbol
  )
{
  return symbol_cast<TDestSymbol>(spSymbol.Get ());
}

template<typename TDestSymbol> TDestSymbol
symbol_cast (
  _In_ const Symbol  &src
  );
...
public:
    ...
    SymbolIterator(
                   _In_ IDebugHostSymbolEnumerator  *pChildEnum
                   ) : SymbolIterator(
                                      pChildEnum,
                                      0
                                      )
...
public:
  ...
  TSymChild
  operator[] (
    _In_z_ const wchar_t  *childName
    ) const
  {
  ...
  TSymChild
  operator[] (
    _In_ const std::wstring  &fieldName
    ) const
  {
    if (fieldName.empty ()) {
...
public:
    ...
    GenericArgumentsIterator(
                             _In_ const GenericArgumentsIterator  &rhs
                             ) = default;
    GenericArgumentsIterator(
                             GenericArgumentsIterator  &&rhs
                             ) = default;
    GenericArgumentsIterator &
    operator= (
      _In_ const GenericArgumentsIterator  &rhs
      ...
      )
    {
      if ((m_value.GetSymbolInterface () == nullptr) && (rhs.m_value.GetSymbolInterface () == nullptr)) {
        ...
        return (m_spType.Get () == rhs.m_spType.Get () &&
...
public:
    ...
    ArrayDimensionsIterator(
                            ) : m_pArrayDimensions (nullptr), m_dimsCount (0), m_pos (0)
    {
    }

    ArrayDimensionsIterator(
                            _In_ ULONG64                    dimsCount,
    ...
    ArrayDimensionsIterator(
                            _In_ const ArrayDimensionsIterator  &rhs
                            ) = default;
    ArrayDimensionsIterator(
                            ArrayDimensionsIterator  &&rhs
                            ) = default;
    ArrayDimensionsIterator &
    operator= (
      _In_ const ArrayDimensionsIterator  &rhs
...
public:
  ...
  {
    return static_cast<size_t>(m_dimsCount);
  }
...
public:
    ...
    ParameterTypesIterator(
                           _In_ const ParameterTypesIterator  &rhs
                           ) = default;
    ParameterTypesIterator(
                           ParameterTypesIterator  &&rhs
                           ) = default;
    ParameterTypesIterator &
    operator= (
      _In_ const ParameterTypesIterator  &rhs
...
public:
  ...
  HostContext(
              _In_ IDebugHostContext  *pHostContext
              )
  {
  ...
  HostContext(
              _In_ const ComPtr<IDebugHostContext>  &spHostContext
              ) : m_spHostContext (spHostContext), m_isDeferred (false)
  {
  }

  HostContext(
              _In_ ComPtr<IDebugHostContext>  &&spHostContext
              ) : m_spHostContext (std::move (spHostContext)), m_isDeferred (false)
  {
  }

  HostContext(
              _In_ const HostContext  &src
              ) : m_spHostContext (src.m_spHostContext), m_isDeferred (src.m_isDeferred)
  {
  }

  HostContext(
              _In_ HostContext  &&src
              ) : m_spHostContext (std::move (src.m_spHostContext)), m_isDeferred (src.m_isDeferred)
  {
  }
  ...
  {
    m_spHostContext = src.m_spHostContext;
    m_isDeferred    = src.m_isDeferred;
    return *this;
  }
  ...
  {
    m_spHostContext = std::move (src.m_spHostContext);
    m_isDeferred    = src.m_isDeferred;
    return *this;
  }
  ...
  {
    if (m_isDeferred) {
      return USE_CURRENT_HOST_CONTEXT;
    }
  ...
  bool
  operator== (
    _In_ const HostContext  &otherContext
    ) const
  {
    if (m_isDeferred) {
  ...
  bool
  operator== (
    _In_ IDebugHostContext  *pOtherContext
    ) const
  {
    if (m_isDeferred) {
...
public:
  ...
  Symbol(
         _In_ ComPtr<IDebugHostSymbol>  spSymbol
         ) : m_spSymbol (std::move (spSymbol))
  {
  }
  ...
  {
    AssignSymbol (src.m_spSymbol.Get ());
    return *this;
  }
  ...
  {
    MoveSymbol (std::move (src.m_spSymbol));
    return *this;
  }

  operator IDebugHostSymbol * () const {
  ...
  bool
  operator== (
    _In_ const IDebugHostSymbol  *pOtherSymbol
    ) const
  {
    if (m_spSymbol.Get () == pOtherSymbol) {
      return true;
    }

    if (IsEmpty () || (pOtherSymbol == nullptr)) {
      return false;
    }
  ...
  bool
  operator== (
    _In_ const Symbol  &otherSymbol
    ) const
  {
    if (m_spSymbol.Get () == otherSymbol.m_spSymbol.Get ()) {
      return true;
    }

    if (IsEmpty () || otherSymbol.IsEmpty ()) {
      return false;
    }
  ...
  //
  Details::SymbolChildrenRef<Symbol, Symbol>
  Children (
    ) const
  {
    CheckObject ();
...
protected:
  ...
  void
  MoveSymbol (
    _In_ ComPtr<IDebugHostSymbol>  &&srcSymbol
    )
  {
...
public:
  ...
  static Module
  FromLocation (
    _In_ const HostContext  &moduleContext,
    _In_ const Location     &locationWithinModule
    )
  {
  ...
  Module(
         _In_ ComPtr<IDebugHostModule>  spModule
         ) : Symbol (spModule.Detach ())
  {
  }

  Module(
         _In_ const Module  &src
         ) : Symbol (src)
  {
  }
  ...
  {
    return static_cast<Module &>(Symbol::operator= (pModule));
  }
  ...
  {
    return static_cast<Module &>(Symbol::operator= (spModule.Detach ()));
  }
  ...
  {
    return static_cast<Module &>(Symbol::operator= (src));
  }
  ...
  {
    return static_cast<Module &>(Symbol::operator= (std::move (src)));
  }

  operator IDebugHostModule * () const {
    return AsModule ();
  }
  IDebugHostModule *
  operator-> (
  ...
  TryGetContainingSymbol (
    _In_ ULONG64            moduleOffset,
    _Out_ SymbolWithOffset  *pResultSymbol
    ) const
  {
...
public:
  ...
  Constant(
           _In_ IDebugHostConstant  *pConstant
           ) : Symbol (pConstant)
  {
  }

  Constant(
           _In_ ComPtr<IDebugHostConstant>  spConstant
           ) : Symbol (spConstant.Detach ())
  {
  }

  Constant(
           _In_ const Constant  &src
           ) : Symbol (src)
  {
  }
  ...
  {
    return static_cast<Constant &>(Symbol::operator= (pConstant));
  }
  ...
  {
    return static_cast<Constant &>(Symbol::operator= (spConstant.Detach ()));
  }
  ...
  {
    return static_cast<Constant &>(Symbol::operator= (src));
  }
  ...
  {
    return static_cast<Constant &>(Symbol::operator= (std::move (src)));
  }

  operator IDebugHostConstant * () const {
    return AsConstant ();
  }
  IDebugHostConstant *
  operator-> (
...
public:
  ...
  Field(
        _In_ IDebugHostField  *pField
        ) : Symbol (pField)
  {
  }

  Field(
        _In_ ComPtr<IDebugHostField>  spField
        ) : Symbol (spField.Detach ())
  {
  }

  Field(
        _In_ const Field  &src
        ) : Symbol (src)
  {
  }
  ...
  {
    return static_cast<Field &>(Symbol::operator= (pField));
  }
  ...
  {
    return static_cast<Field &>(Symbol::operator= (spField.Detach ()));
  }
  ...
  {
    return static_cast<Field &>(Symbol::operator= (src));
  }
  ...
  {
    return static_cast<Field &>(Symbol::operator= (std::move (src)));
  }

  operator IDebugHostField * () const {
    return AsField ();
  }
  IDebugHostField *
  operator-> (
  ...
  {
    return GetLocationKind () == LocationMember;
  }
  ...
  {
    return GetLocationKind () == LocationStatic;
  }
  ...
  {
    return GetLocationKind () == LocationConstant;
  }
...
public:
  ...
  BaseClass(
            _In_ IDebugHostBaseClass  *pBaseClass
            ) : Symbol (pBaseClass)
  {
  }

  BaseClass(
            _In_ ComPtr<IDebugHostBaseClass>  spBaseClass
            ) : Symbol (spBaseClass.Detach ())
  {
  }

  BaseClass(
            _In_ const BaseClass  &src
            ) : Symbol (src)
  {
  }
  ...
  {
    return static_cast<BaseClass &>(Symbol::operator= (pBaseClass));
  }
  ...
  {
    return static_cast<BaseClass &>(Symbol::operator= (spBaseClass.Detach ()));
  }
  ...
  {
    return static_cast<BaseClass &>(Symbol::operator= (src));
  }
  ...
  {
    return static_cast<BaseClass &>(Symbol::operator= (std::move (src)));
  }

  operator IDebugHostBaseClass * () const {
    return AsBaseClass ();
  }
  IDebugHostBaseClass *
  operator-> (
...
public:
  ...
  Type(
       _In_ ComPtr<IDebugHostType>  spType
       ) : Symbol (spType.Detach ())
  {
  }
  ...
  {
    return static_cast<Type &>(Symbol::operator= (pType));
  }
  ...
  {
    return static_cast<Type &>(Symbol::operator= (spType.Detach ()));
  }
  ...
  {
    return static_cast<Type &>(Symbol::operator= (src));
  }
  ...
  {
    return static_cast<Type &>(Symbol::operator= (std::move (src)));
  }

  operator IDebugHostType * () const {
    return AsType ();
  }
  IDebugHostType *
  operator-> (
  ...
  Type(
       _In_ const Module     &module,
       _In_z_ const wchar_t  *pTypeName
       )
  {
    ComPtr<IDebugHostType>  spType;
  ...
  //
  Details::SymbolChildrenRef<Type, Field>
  Fields (
    ) const
  {
    CheckObject ();
  ...
  //
  Details::SymbolChildrenRef<Type, BaseClass>
  BaseClasses (
    ) const
  {
    CheckObject ();
  ...
  //
  Details::GenericArgumentsRef<Symbol>
  GenericArguments (
    ) const
  {
    CheckObject ();
  ...
  //
  Details::ParameterTypesRef<ClientEx::Type>
  ParameterTypes (
    ) const
  {
    CheckObject ();
...
{
  return symbol_cast<TDestSymbol>(src.GetSymbolInterface ());
}
...
public:
    ...
    ) const
  {
    ...
    HRESULT               hr = m_spIndexable->GetAt (
                                                m_spSrcObject.Get (),
                                                m_packSize,
  ...
  {
    return GetValue ().As<TType>();
  }

  template<typename TType> explicit
  operator TType (
    ) const
  {
    return As<TType>();
...
private:
  ...
  void
  SetValue (
    _In_ const TObj  &value
    )
  {
    HRESULT  hr = m_spIndexable->SetAt (
                                   m_spSrcObject.Get (),
                                   m_packSize,
                                   reinterpret_cast<IModelObject **>(m_indexers.get ()),
                                   value
...
private:
  ...
  //
  ObjectKeyRef<TObj, TMeta> operator[] (
    _In_z_ const wchar_t  *keyName
    )
  {
...
public:
  ...
  //
  ObjectFieldRef<TObj> operator[] (
    _In_z_ const wchar_t  *fieldName
    )
  {
...
public:
  ...
  DereferenceReference(
                       _In_ const DereferenceReference  &src
                       ) : m_obj (src.m_obj)
  {
  }

  DereferenceReference(
                       _In_ DereferenceReference  &&src
...
struct StringExtractorHelper<wchar_t *> {
  static _Ret_z_ const wchar_t *
  GetString (
    _In_z_ const wchar_t  *pc
    )
  {
    return pc;
  }
...
public:
  ...
  TypeSignature(
                _In_ const ComPtr<IDebugHostTypeSignature>  &spTypeSignature
                ) : m_spTypeSignature (spTypeSignature)
  {
  }

  TypeSignature(
                _In_ ComPtr<IDebugHostTypeSignature>  &&spTypeSignature
                ) : m_spTypeSignature (std::move (spTypeSignature))
  {
  }

  TypeSignature(
                _In_ const TypeSignature  &src
                ) : m_spTypeSignature (src.m_spTypeSignature)
  {
  }

  TypeSignature(
                _In_ TypeSignature  &&src
  ...
  //
  TypeSignature(
                _In_z_ const wchar_t  *signature
                )
  {
    ComPtr<IDebugHostSymbols>  spHostSym;
                ...
                )
  {
    ...
    ClientEx::CheckHr (ClientEx::GetHost ()->QueryInterface (IID_PPV_ARGS (&spHostSym)));
    ClientEx::CheckHr (
                spHostSym->CreateTypeSignatureForModuleRange (
                             pSignature,
                             pModuleName,
                             nullptr,
                             nullptr,
                ...
                )
  {
    ...
    if (allowLooseNameMatch) {
      ...
      ClientEx::CheckHr (
                  spHostSym3->CreateTypeSignatureForModuleRange2 (
                                pSignature,
                                pModuleName,
                                allowLooseNameMatch,
                                nullptr,
  ...
  operator IDebugHostTypeSignature * () const {
    return m_spTypeSignature.Get ();
  }
...
public:
  ...
  Metadata(
           _In_ const Metadata  &src
           ) : m_spKeyStore (src.m_spKeyStore)
  {
  }

  Metadata(
           _In_ Metadata  &&src
           ) : m_spKeyStore (std::move (src.m_spKeyStore))
  {
  }

  Metadata(
           _In_ IKeyStore  *pKeyStore
           ) : m_spKeyStore (pKeyStore)
  {
  }

  Metadata(
           _In_ ComPtr<IKeyStore>  &spKeyStore
           ) : m_spKeyStore (spKeyStore)
  {
  }

  Metadata(
           _In_ const ComPtr<IKeyStore>  &spKeyStore
           ) : m_spKeyStore (spKeyStore)
  {
  }
  ...
  Metadata(
           _In_ ComPtr<IKeyStore>  &&spKeyStore
           ) : m_spKeyStore (std::move (spKeyStore))
  {
  }

  Metadata &
  operator= (
    _In_ const Metadata  &rhs
    )
  {
  ...
  explicit
  Metadata(
           _In_ TArgs &&...  initializers
           );

  operator IKeyStore * () const {
    return m_spKeyStore.Get ();
  }
  IKeyStore *
  operator-> (
    ) const
...
public:
  ...
  static Object
  CreateTyped (
    _In_ const Type      &objectType,
    _In_ const Location  &objectLocation
    )
  {
    ComPtr<IModelObject>  spObj;
  ...
  static Object
  CreatePointer (
    _In_ const Type  &pointerType,
    _In_ ULONG64     ptrValue
    )
  {
  ...
  static Object
  CreateError (
    _In_ const std::exception_ptr  &exptr
    )
  {
    ComPtr<IModelObject>  spError;
  ...
  static Object
  FromExpressionEvaluation (
    _In_ const HostContext  &evaluationContext,
    _In_ TStr               &&expression
    )
  {
    ComPtr<IModelObject>         spObj;
  ...
  static Object
  FromGlobalSymbol (
    const HostContext  &symbolContext,
    TStr1              &&moduleName,
    TStr2              &&symbolName
    )
  {
  ...
  Object(
         _In_ ComPtr<IModelObject>  &src
         ) : m_spObject (src)
  {
  }

  Object(
         _In_ const ComPtr<IModelObject>  &src
         ) : m_spObject (src)
  {
  }
  ...
  template<typename TArg> explicit
  operator TArg (
    ) const
  {
    return As<TArg>();
  ...
  {
    return IsEqualTo (std::forward<TArg>(other));
  }
  ...
  {
    return !operator== (std::forward<TArg>(other));
  }
  ...
  //
  template<typename TArg> bool
  operator< (
    _In_ TArg  &&other
    ) const
  {
    return CompareTo (std::forward<TArg>(other)) < 0;
  }
  ...
  //
  Details::ObjectKeysRef<Object, Metadata>
  Keys (
    ) const
  {
  ...
  KeyValue (
    _In_z_ const wchar_t  *keyName,
    _Out_opt_ Metadata    *pMetadata = nullptr
    ) const
  {
  ...
  //
  Details::ObjectFieldsRef<Object>
  Fields (
    ) const
  {
  ...
  //
  Details::DereferenceReference<Object>
  Dereference (
    ) const
  {
  ...
  //
  template<typename ... TArgs> Object
  Call (
    _In_ const Object  &instance,
    TArgs &&...        callArguments
    ) const;
  ...
  template<typename ... TArgs> Object
  CallMethod (
    _In_z_ const wchar_t  *methodName,
    TArgs &&...           callArguments
    ) const
  {
  ...
  // Indexes an object
  //
  template<typename ... TArgs> Details::IndexableReference<Object, std::unique_ptr<Object[]> > operator[] (
    TArgs &&...  indexers
    ) const
  {
  ...
  template<typename ... TArgs> Details::IndexableReference<Object, std::unique_ptr<Object[]> >
  Index (
    TArgs &&...  indexers
    ) const;
  ...
  {
    return ToDisplayString (Metadata ());
  }
  ...
  bool
  TryToDisplayString (
    _Out_ std::wstring   *pDisplayString,
    _In_ const Metadata  &metadata
    ) const
  {
  ...
  Object
  ConstructInstance (
    _In_ Deconstruction  &deconstruction
    );
...
public:
  ...
  IndexedValue(
               _In_ const IndexedValue  &src
               ) : m_value (src.m_value), m_indicies (src.m_indicies)
  {
  }

  IndexedValue(
               _In_ IndexedValue  &&src
               ) : m_value (std::move (src.m_value)), m_indicies (std::move (src.m_indicies))
  {
  }
    ...
    )
  {
    ...
    m_indicies = std::move (src.m_indicies);
    return *this;
  }
...
public:
  ...
  explicit GeneratedIterable(
                             _In_ std::function<TContainer (void)>  acquireContainer
                             ) :
    m_acquireContainer (acquireContainer)
  {
  }

  std::function<TContainer (void)> const &
  GetAcquireFunction (
    ) const
  {
    return m_acquireContainer;
  }
...
public:
  ...
  ValueWithMetadata(
                    _In_ const ValueWithMetadata  &src
                    ) = default;
  ValueWithMetadata(
                    _In_ ValueWithMetadata  &&src
                    ) = default;
...
public:
  ...
  Deconstruction(
                 _In_z_ const wchar_t                *pConstructableModel,
...
struct DeferredResourceString : public ResourceString {
  template<typename ... TArgs> DeferredResourceString(
                                                      TArgs &&...  args
                                                      ) : ResourceString (std::forward<TArgs>(args)...)
  {
  }
};
...
template<typename TRet, typename ... TArgs>
StdFunctionTraits<TRet, TArgs...>
GetFunctionTraits (
  _In_ const std::function<TRet (TArgs...)> &
  );
...
template<typename TVal> struct MetadataTraits<ValueWithMetadata<TVal> > {
  ...
  static void
  FillMetadata (
    ValueWithMetadata<TVal> const            &val,
    _Outptr_opt_result_maybenull_ IKeyStore  **ppMetadata
    )
  {
    if (ppMetadata) {
...
template<typename TVal, typename ... TIndices> struct MetadataTraits<IndexedValue<TVal, TIndices...> > {
  static void
  FillMetadata (
    IndexedValue<TVal, TIndices...>          &val,
    _Outptr_opt_result_maybenull_ IKeyStore  **ppMetadata
    )
  {
...
struct IndexerTraits<ClientEx::IndexedValue<TVal, TIndicies...>, TIter, IsRandom> {
  ...
  static void
  CreateIndexers (
    _In_ const ClientEx::IndexedValue<TVal, TIndicies...>  &indexedValue,
    _In_ const TIter & /*itBegin*/,
    _In_ const TIter & /*itCur*/,
    _In_ ULONG64                dimensionality,
    _Out_opt_ ClientEx::Object  *pIndexers
...
private:
    ...
    )
  {
    ...
    //
    if (IsVariableArgumentPosition_v<T, TArgs...>) {
      return false;
    }
...
struct Unpacker<TTuple, i, 0> {
  ...
  UnpackInto (
    _In_ size_t /*packSize*/,
    _In_ IModelObject ** /*ppArgumentPack*/,
    TTuple &                                                                                              /*tuple*/
    )
  {
  }
...
constexpr decltype(auto)  ApplyImpl (
                            F && f,
...
Object
InvokeFunctionFromPack (
  _In_ const std::function<TRet (TArgs...)>  &func,
  _In_ const Object                          &contextObj,
  _In_ size_t                                packSize,
  _In_reads_ (packSize) IModelObject         **ppArgumentPack,
  _Outptr_opt_result_maybenull_ IKeyStore    **ppMetadata,
...
{
  return InvokeFunctionFromPack (
           typename FunctorTraits<TFunc>::FunctionType (func),
           contextObj,
           packSize,
           pArgumentPack,
           ppMetadata,
...
public:
  ...
  BoxedProperty(
                _In_ const TGetter  &getterFunc,
                _In_ const TSetter  &setterFunc
                ) :
...
public:
    ...
    Iterator(
             _In_ IIterableConcept  *pIterable,
             _In_ T                 *pArray,
             _In_ size_t            arraySize
             ) :
...
inline void
ThrowIfDetached (
  _In_ const DataModelReference  &linkRef
  )
{
...
public:
  ...
  BoundIterator(
                _In_ DataModelReference      &&transferredLinkReference,
...
protected:
  ...
  GetObject (
    _In_opt_ IModelObject  *pOverrideObject = nullptr
    )
  {
  ...
  GeneratorType
  GetGenerator (
    _In_ const Object  &instanceObject
    )
  {
...
public:
  ...
  BoundIterable(
                ...
                _In_ IModelObject          *pOverrideObject
                                  ...
                                  std::move (transferredLinkReference),
                                  nullptr,
...
protected:
  ...
  CheckType (
    _In_ const Object     &src,
    _In_ ModelObjectKind  requiredKind
    )
  {
    ModelObjectKind  mk;
...
inline Object
BoxProperty (
  _In_ const TGetFunc  &getFunc,
  _In_ const TSetFunc  &setFunc
  )
{
...
struct BoxObjectInterface : public BoxObjectBase {
  static Object
  Box (
    _In_ TInterface  *interfacePointer
    )
  {
    ...
    vtUnk.vt      = VT_UNKNOWN;
    vtUnk.punkVal = interfacePointer;
...
public:
  ...
  SpotLinkReference(
                    ) : m_dataRef (std::make_shared<DataModelReferenceInfo>())
  {
  }

  SpotLinkReference(
                    _In_ SpotLinkReference  &&src
                    ) : m_dataRef (std::move (src.m_dataRef))
  {
  }
...
public:
    ...
    )
  {
    ...
    auto  itemProjectorFunc = [](_In_ TItem eref) {
                                return eref;
                              };
...
template<typename TRet, typename ... TArgs>
struct BoxObject<TRet (*)(
  TArgs...
  )> : public Details::BoxObjectMethod<TRet (*)(
    TArgs...
    )> {
};

template<typename TRet, typename ... TArgs>
struct BoxObject<TRet (TArgs...)> : public Details::BoxObjectMethod<TRet (*)(
    TArgs...
    )> {
};
...
struct BoxObject<IndexedValue<TVal, TIndicies...> > {
  static Object
  Box (
    _In_ const IndexedValue<TVal, TIndicies...>  &src
    )
  {
...
struct BoxObject<ValueWithMetadata<TVal> > {
  static Object
  Box (
    _In_ const ValueWithMetadata<TVal>  &src
    )
  {
    return BoxObject<TVal>::Box (src.GetValue ());
  }
...
struct BoxObject<Details::ObjectKeyRef<Object, Metadata> > {
  static Object
  Box (
    _In_ const Details::ObjectKeyRef<Object, Metadata>  &keyRef
    )
  {
...
struct BoxObject<Details::ObjectFieldRef<Object> > {
  static Object
  Box (
    _In_ const Details::ObjectFieldRef<Object>  &fieldRef
    )
  {
...
struct BoxObject<Details::DereferenceReference<Object> > {
  static Object
  Box (
    _In_ const Details::DereferenceReference<Object>  &derefRef
    )
  {
...
struct BoxObject<Details::IndexableReference<Object, TPack> > {
  static Object
  Box (
    _In_ const Details::IndexableReference<Object, TPack>  &indexableRef
    )
  {
...
struct BoxObject<ResourceString> {
  static Object
  Box (
    _In_ const ResourceString  &rscString
    )
  {
...
struct BoxObject<DeferredResourceString> {
  static Object
  Box (
    _In_ const DeferredResourceString  &rscString
    )
  {
...
struct BoxObject<GeneratedIterable<TContainer> > {
  ...
  static Object
  Box (
    _In_ const GeneratedIterable<TContainer>  &src
    )
  {
    //
...
struct BoxObject<std::experimental::generator<TGen> > {
  static Object
  Box (
    _In_ const std::experimental::generator<TGen>  &src
    )
  {
...
inline std::optional<Object>
Metadata::TryGetKeyValue (
  _In_z_ const wchar_t  *keyName
  ) const
{
  ComPtr<IModelObject>  spValue;
...
template<typename ... TArgs>
Details::IndexableReference<Object, Details::ParameterPack>
Object::Index (
  TArgs &&...  indexers
  ) const
{
  ...
  ) const
{
  ...
  if (GetObject () == otherObj.GetObject ()) {
    return true;
  }

  if ((GetObject () == nullptr) || (otherObj.GetObject () == nullptr)) {
    return false;
  }
...
template<typename TTuple, size_t i, size_t remaining>
void
RegularUnpacker<TTuple, i, remaining>::UnpackInto (
  _In_ size_t                         packSize,
  _In_reads_ (packSize) IModelObject  **ppArgumentPack,
  TTuple                              &tuple
  )
...
public:
  ...
  template<typename ... TArgs> TypeSignatureRegistration(
                                                         TArgs &&...  args
                                                         ) : TypeSignature (std::forward<TArgs>(args)...)
  {
  }
  ...
  void
  Apply (
    _In_ const ClientEx::Object  &model
    )
  {
...
public:
  ...
  template<typename ... TArgs> TypeSignatureExtension(
                                                      TArgs &&...  args
                                                      ) : TypeSignature (std::forward<TArgs>(args)...)
  {
  }
...
public:
  ...
  NamedModelParent(
                   _In_z_ const wchar_t  *parentModelName
                   ) : m_parentModelName (parentModelName)
  {
  }

  NamedModelParent(
                   _In_ const std::wstring  &parentModelName
                   ) : m_parentModelName (parentModelName)
  {
  }

  NamedModelParent(
                   _In_ std::wstring  &&parentModelName
                   ) : m_parentModelName (std::move (parentModelName))
  {
  }

  NamedModelParent(
                   _In_ const NamedModelParent  &src
                   ) : m_parentModelName (src.m_parentModelName)
  {
  }

  NamedModelParent(
                   _In_ NamedModelParent  &&src
                   ) : m_parentModelName (std::move (src.m_parentModelName))
  {
  }
...
public:
  ...
  NamedModelRegistration(
                         _In_z_ const wchar_t  *modelName
                         ) : m_modelName (modelName)
  {
  }

  NamedModelRegistration(
                         _In_ const std::wstring  &modelName
                         ) : m_modelName (modelName)
  {
  }

  NamedModelRegistration(
                         _In_ std::wstring  &&modelName
                         ) : m_modelName (std::move (modelName))
  {
  }

  NamedModelRegistration(
                         _In_ const NamedModelRegistration  &src
                         ) : m_modelName (src.m_modelName)
  {
  }

  NamedModelRegistration(
                         _In_ NamedModelRegistration  &&src
...
public:
  ...
  NamespacePropertyParent(
                          _In_ const NamespacePropertyParent  &src
                          ) :
    m_modelName (src.m_modelName),
  ...
  NamespacePropertyParent(
                          _In_ NamespacePropertyParent  &&src
                          ) :
    m_modelName (std::move (src.m_modelName)),
  ...
  NamespacePropertyParent(
                          ...
                          _In_ TStr2               &&namespaceName,
                          _In_ TStr3               &&propertyName,
                          _In_ ClientEx::Metadata  metadata
                          ) :
    m_metadata (std::move (metadata))
  {
    m_modelName     = ClientEx::Details::ExtractString (modelName);
    ...
    )
  {
    ...
    ClientEx::CheckHr (
                spManager2->AcquireSubNamespace (
                              m_modelName.c_str (),
...
public:
  ...
  FilteredNamespacePropertyParent(
                                  _In_ const FilteredNamespacePropertyParent  &src
                                  ) :
    m_modelName (src.m_modelName),
    m_namespaceName (src.m_namespaceName),
    m_propertyName (src.m_propertyName),
  ...
  FilteredNamespacePropertyParent(
                                  _In_ FilteredNamespacePropertyParent  &&src
                                  ) :
    m_modelName (std::move (src.m_modelName)),
    m_namespaceName (std::move (src.m_namespaceName)),
    m_propertyName (std::move (src.m_propertyName)),
    ...
    )
  {
    ...
    ClientEx::CheckHr (
                spManager3->AcquireFilteredSubNamespace (
                              m_modelName.c_str (),
                              m_namespaceName.c_str (),
                              m_propertyName.c_str (),
                              nullptr,
...
public:
  ...
  BasicStorage(
               _In_ const TInstance  &instance,
               _In_ ULONG64          typeHash
               ) :
    m_instance (instance),
    m_typeHash (typeHash)
  {
...
public:
  ...
  SharedStorage(
                _In_ std::shared_ptr<TInstance>  sharedInstance,
                _In_ ULONG64                     typeHash
                ) :
...
public:
  ...
  UniqueStorage(
                _In_ std::unique_ptr<TInstance>  uniqueInstance,
                _In_ ULONG64                     typeHash
                ) :
...
public:
  ...
  DataModelConcept(
                   _In_ TClass      *pClass,
                   _In_ NameMethod  nameMethod
                   ) : m_pClass (pClass), m_nameMethod (nameMethod)
  {
  }
...
public:
  ...
  IFACEMETHOD (CreateInstance)(
    ...
    *ppInstance = nullptr;
    ...
    try
    {
      ClientEx::Object  result = ClientEx::Details::LiteralInvokeFunctionFromPack (
                                                      m_constructableProjector,
...
public:
  ...
  IFACEMETHOD (GetConstructableModelName)(
    _In_ IModelObject * /*pContextObject*/,
  ...
  IFACEMETHOD (GetConstructorArgumentCount)(
    _In_ IModelObject *pContextObject,
  ...
  IFACEMETHOD (GetConstructorArguments)(
    _In_ IModelObject *pContextObject,
    _In_ ULONG64 argCount,
...
struct ExtensionNameAcquisition<NamedModelRegistration, TArgs...> {
  ...
  FillName (
    _Inout_ std::wstring               &modelName,
    _In_ const NamedModelRegistration  &nameRegistration,
    _In_ const TArgs &...              records
    )
  {
    if (modelName.empty ()) {
...
struct TypedInstanceRegistrationVerification {
  ...
  {
    static_assert (
      IsValidTypedInstanceRegistrationType_v<TReg>,
      "Illegal registration kind for a TypedInstanceModel<T>"
      );
  }
};

struct EmptyVerification {
  static void
  Verify (
    )
  {
...
public:
  ...
  const ClientEx::Details::DataModelReference &
  GetLinkReference (
    ) const
  {
    return m_dataRef;
...
public:
  ...
  ExtensionModel(
                 _In_ ClientEx::Metadata  &&metadata
                 ) : BaseDataModel (metadata)
  {
  }

  ExtensionModel(
                 ) : BaseDataModel (ClientEx::Metadata ())
  {
  }
    ...
    )
  {
    ...
    if constexpr (std::is_invocable_v<TGetFunc, ClientEx::Object>) {
      // Prevent noise from failure of the assertion above
  ...
  AddStringDisplayableFunction (
    _In_ TClass *pDerived,
    _In_ TRet (TClass::*classMethod)(_In_ TObj, _In_ TMeta)
    )
  {
  ...
  AddStringDisplayableFunction (
    _In_ const TClass *pDerived,
    _In_ TRet (TClass::*classMethod)(_In_ TObj, _In_ TMeta) const
    )
  {
  ...
  AddEquatableFunction (
    _In_ TClass *pDerived,
    _In_ bool (TClass::*classMethod)(_In_ TObj1, _In_ TObj2)
    )
  {
  ...
  AddEquatableFunction (
    _In_ const TClass *pDerived,
    _In_ bool (TClass::*classMethod)(_In_ TObj1, _In_ TObj2) const
    )
  {
  ...
  AddComparableFunction (
    _In_ TClass *pDerived,
    _In_ int (TClass::*classMethod)(_In_ TObj1, _In_ TObj2)
    )
  {
  ...
  AddComparableFunction (
    _In_ const TClass *pDerived,
    _In_ int (TClass::*classMethod)(_In_ TObj1, _In_ TObj2) const
    )
  {
  ...
  AddGeneratorFunction (
    _In_ TClass          *pDerived,
    _In_ TGen (TClass::  *classMethod )(_In_  TObj)
    )
  {
    ...
    static_assert (
      std::is_base_of_v<std::decay_t<decltype(*this)>, std::decay_t<TClass> >,
...
private:
  ...
  template<typename ... TArgs>
  void
  CompleteExtensionModelInitialization (
    _In_ TArgs &&...  registrations
    )
  {
    //
...
protected:
  ...
  void
  BindIterator (
    _In_ const TItemProjector  &itemProjectorFunc
    );
};
...
{
public:
  TypedInstanceModelBaseSelector(
                                 _In_ const ClientEx::Metadata  &metadata
                                 ) :
...
public:
  ...
  ClientEx::Object
  CreateInstance (
    _In_ const TInstance  &instanceData
    )
  {
  ...
  CreateInstance (
    _In_ std::shared_ptr<TInstance>  instanceData
    )
  {
  ...
  std::enable_if_t<std::is_same_v<StorageData, TInstance>, ClientEx::Object>
  CreateInstance (
    _In_ std::unique_ptr<TInstance>  instanceData
    )
  {
  ...
  bool
  IsObjectInstance (
    _In_ const ClientEx::Object  &obj
    )
  {
...
protected:
    ...
    )
  {
    ...
    if constexpr (std::is_invocable_v<TGetFunc, ClientEx::Object, TInstance &>) {
      // Prevent noise from failure of the assertion above
    ...
    )
  {
    ...
    auto                                   equatableProjectorFunc = [linkRef = std::move (equatableLinkRef), pDerived, equatableClassMethod]
                                                                    ...
                                                                    {
                                                                      ClientEx::Details::ThrowIfDetached (linkRef);
                                                                      return (pDerived->*equatableClassMethod)(
  instanceObject,
    ...
    )
  {
    ...
    auto                                   comparableProjectorFunc = [linkRef = std::move (comparableLinkRef), pDerived, comparableClassMethod]
                                                                     ...
                                                                     {
                                                                       ClientEx::Details::ThrowIfDetached (linkRef);
                                                                       return (pDerived->*comparableClassMethod)(
  instanceObject,
  pDerived->GetStoredInstance (instanceObject),
  ClientEx::UnboxObject<TOther>(otherObj)
  );
  ...
  void
  AddDeconstructableFunction (
    _In_ TStr &&constructableModelName,
    _In_ TClass *pDerived,
    ...
    )
  {
    ...
    spDeconstructable = Make<Details::BoundDeconstructable<TypedInstanceModel<TInstance>, TDeconstructableProjector> >(
                          this,
                          ClientEx::Details::ExtractString (constructableModelName),
                          deconstructableProjectorFunc
                          );
  }
  ...
  {
    return AddDeconstructableFunction (
             std::forward<TStr>(constructableModelName),
...
private:
  ...
  template<typename ... TArgs>
  void
  CompleteTypedInstanceModelInitialization (
    _In_ TArgs &&...  registrations
    )
  {
    //
...
template<typename TItemProjector>
void
IterableTypedInstanceModel<TInstance>::BindIterator (
  _In_ const TItemProjector  &itemProjectorFunc
  )
{
  //

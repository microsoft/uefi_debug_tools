...
public:
    ...
    //
    IFACEMETHOD (GetServiceDependencies)(
    ...
    //
    IFACEMETHOD (InitializeServices)(
      _In_ ServiceNotificationKind /*notificationKind*/,
      _In_ IDebugServiceManager * /*pServiceManager*/,
      _In_ REFGUID                               /*serviceGuid*/
      ) {
    ...
    //
    IFACEMETHOD (NotifyServiceChange)(
      _In_ ServiceNotificationKind /*notificationKind*/,
      _In_ IDebugServiceManager * /*pServiceManager*/,
      _In_ REFGUID /*serviceGuid*/,
    ...
    //
    IFACEMETHOD (LocateSymbolsForImage)(
            ...
            if (SUCCEEDED (hr) && (bytesRead == sizeof (debugDir))) {
                ...
                if ((debugDir.Type == IMAGE_DEBUG_TYPE_CODEVIEW) && (debugDir.AddressOfRawData != 0)) {
                    ...
                    if (SUCCEEDED (hr) && (bytesRead == sizeof (cvSignature))) {
                        ...
                        } else if (cvSignature == 0x3031424E) {
    ...
    VOID
    SetSymbolProvider (
      _In_ ISvcSymbolProvider2  *pProvider
      )
    {
